...
export class RegisterApi {
    ...
    const response = await axios.post<ApiResponse<CipherRequest[]>> (this.getdepartmentRegisterUrl,params);
    ...
    const response = await axios.post<ApiResponse<CipherRequest[]>> (this.getuserRegisterUrl,params);
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getdepartmentTypeUrl);
    return response.data.data;
    }
    //获取企业分类下面的企业
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getdepartmentnameUrl.replace('{departmentId}', departmentId));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpersonnameUrl.replace('{departmentId}', departmentId));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getisDeptIdNumberExistInUrl.replace('{deptName}', deptName));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getDepartmentIdNumExistsUrl.replace('{idType}', idType).replace('{idNum}', idNum));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getDepartmentIdNumExistUrl.replace('{idType}', idType).replace('{idNum}', idNum));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getUserNameExistUrl.replace('{userName}', userName));
    return response.data.data;
    }
     ...
     const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpresonUserNameExistUrl.replace('{userName}', userName));
     return response.data.data;
     }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getdictionaryUrl.replace('{fatherGroupId}', fatherGroupId).replace('{fatherType}', fatherType));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getAllUrl);
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getdiquUrl.replace('{diquid}', diquid).replace('{diqutype}', diqutype));
    return response.data.data;
    }
    //获取个人地区
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpersondiquUrl.replace('{diquid}', diquid).replace('{diqutype}', diqutype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getyhzxUrl.replace('{yhzxid}', yhzxid).replace('{yhzxtype}', yhzxtype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getProvinciascityUrl.replace('{ssqid}',ssqid).replace('{ssqtype}',ssqtype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpersonProvinciascityUrl.replace('{ssqid}', ssqid).replace('{ssqtype}', ssqtype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpersondocumenetTypeUrl.replace('{grzjid}', grzjid).replace('{grzjtype}', grzjtype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getdepartmentdocumenetTypeUrl.replace('{qyzjid}', qyzjid).replace('{qyzjtype}', qyzjtype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getProvinciasUrl.replace('{sid}', sid).replace('{stype}', stype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpersonProvinciasUrl.replace('{sid}', sid).replace('{stype}', stype));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getcityUrl.replace('{cityid}', cityid));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getpesoncityUrl.replace('{cityid}', cityid));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getcountryUrl.replace('{countryid}', countryid));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<PersonRegisterForm[]>> (this.getperosncountryUrl.replace('{countryid}', countryid));
    return response.data.data;
    }
    ...
    const response = await axios.get<ApiResponse<DepartmentRegisterForm[]>> (this.getRsadataUrl);
    return response.data.data;
    }
