...
import {getUrlParam, getQueryString,isAppViewOrLogin} from '@/utils/js/url_path_utils';
...
axios.interceptors.request.use(config => {
  ...
  addSubGuidAndSubSystemName(config)
  //调用添加loading方法
  addLoading(config)
  ...
  if (isAppViewOrLogin()) {
    token = LocalStorageUtil.getItem('X-Gisq-Token');
  }
